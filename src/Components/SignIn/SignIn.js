                        ...
                        <div className="card-body p-5 text-center">
                            ...
                            <div className="mb-md-5 mt-md-4 pb-5">
                                ...
                                <div className="form-floating mb-3">
                                    <input type="email" className="form-control bg-dark text-light" id="floatingInput" placeholder="name@example.com" />
                                ...
                                <button className="btn btn-outline-light btn-lg px-5" type="button" onClick={() => props.isLoggedInSetter(true)}>Login</button>
